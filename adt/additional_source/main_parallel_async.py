...
from utils.openai_models_async import ( 
...
distance_counters_threshold = [60] # [15, 30, 45, 60, 75, 90]  
            ...
            if args.use_llm and not llm_activated:  
                ...
                if any(object in high_dot_history for object in less_than_2_seconds_dict.keys()): # TODO: make this soft having it as a group of objects that was looking, Red Clock was within a group 
                    ...
                    while not success and retry_count < max_retries:
                        llm_response = await activate_llm(history_log_string, parameters)

                        if llm_response:
                            objects_possibility, rationale, predicted_objects, goal = process_llm_response(llm_response, parameters)
                    ...
                    if success:
                        ...
                        # write_to_excel(
                        #     filtered_names_high_dot_counts, 
                        #     filtered_names_low_distance_counts, 
                        #     filtered_names_time_to_approach, 
                        #     filtered_names_dot, 
                        #     filtered_names_distances, 
                        #     predictions_dict, 
                        #     goals_dict, 
                        #     args.sequence_path, 
                        #     parameter_folder_name, 
                        ...
                        print("Exceeded maximum retries. Skipping this parameter combination.")
                        logging.error(f"Exceeded maximum retries for parameters: {parameters}")
...
async def run_all_simulations(param_combinations):
    ...
    tasks = [asyncio.create_task(run_simulation(params)) for params in param_combinations]
...
if __name__ == "__main__":
    asyncio.run(run_all_simulations(param_combinations))